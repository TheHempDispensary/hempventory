...
export const getUntrackedItems = () => api.get("/api/inventory/untracked");
...
export const bulkRemoveCategory = (skus: string[], categoryName: string) =>
  api.post("/api/inventory/bulk-remove-category", { skus, category_name: categoryName });

export const setItemCategories = (sku: string, categoryNames: string[]) =>
  api.post("/api/inventory/set-item-category", { sku, category_names: categoryNames });
